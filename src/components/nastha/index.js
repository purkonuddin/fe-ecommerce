...
handleChange=(validationFunc, evt) => {
  ...
  render() {  
    ...
    return (
        <div key={0}>
            <Tabs selected={ 0 }>
                <div style={{position: "fixed"}} id="navbar-brand" className="mt-2 ml-lg-5">
                ...
                <TabPanel>
                <div className="p-5 row" id="dashboard">
                    {
                ...
                <TabPanel> 
                    <div className="p-5 row" id="add-event">
                ...
                <TabPanel>
                    <div className="p-5 col" id="tabel-event">
                        <div className="row">
